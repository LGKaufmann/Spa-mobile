...
const LoginProfesionalesApp: React.FC = () => {
    ...
    <main className="flex items-center justify-center h-screen mx-auto relative">
      ...
      >
        ...
        <section className="w-full flex flex-col items-center gap-4">
          ...
          <button
            onClick={() => navigate('/registroApp')} // Redirige al registro sin el Link
            className="w-full h-12 bg-[#cb0c4f] rounded-3xl text-base text-white font-semibold transition-transform transform hover:scale-105 hover:shadow-lg"
          >
...
export default LoginProfesionalesApp;
